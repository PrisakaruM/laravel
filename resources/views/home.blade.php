...
@section('navbar')
    ...
    <div class="w3-top">
        <div class="w3-bar w3-black w3-card">
            ...
            <a href="{{$app->make('url')->to('/posts')}}" class="w3-bar-item w3-button w3-padding-large w3-hide-small">BLOG</a>
    ...
    <div id="navDemo" class="w3-bar-block w3-black w3-hide w3-hide-large w3-hide-medium w3-top" style="margin-top:46px">
        <a href="{{$app->make('url')->to('/posts')}}" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">BLOG</a>
    </div>
@endsection
